...
- 🔭 I’m currently working on **thls.pl** | freelancer
...
- **Frontend:** HTML5, CSS3, JavaScript ❤, TypeScript, ReactJS, SolidJS, Tailwind CSS, Three.js, React Three Fiber, Farmer Motion, Framer Motion 3D, Astro, Gsap
 
- **Backend:** Node.js, Express, PHP, Astro, Next.js 13, Socket.io, WebSocket, Vite, CRA, Electron, php, golang
